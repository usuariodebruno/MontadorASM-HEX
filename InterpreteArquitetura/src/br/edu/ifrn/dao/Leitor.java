	...
	public ArrayList<String> coverteHexadecimal(ArrayList<String> linhas) {
		...
		for (String linha : linhas) {
			if (linha.length() == 32) {
				...
				String a = linhaQuebrada[0].concat(
						linhaQuebrada[1].concat(linhaQuebrada[2].concat(linhaQuebrada[3].concat(linhaQuebrada[4])
								.concat(linhaQuebrada[5]).concat(linhaQuebrada[6].concat(linhaQuebrada[7])))));
